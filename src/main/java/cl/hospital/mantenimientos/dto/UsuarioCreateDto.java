...
public class UsuarioCreateDto {
    ...
    @Size(min = 6, max = 72, message = "contrasena debe tener entre 6 y 72 caracteres")
    ...
    public UsuarioCreateDto(Long idRol, String nombreCompleto, String correo, String contrasena, Boolean activo) {
        this.idRol = idRol;
